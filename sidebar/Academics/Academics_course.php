    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <table class="table mt-3">
                ...
                <tbody>
                    <tr>
                        <td><input type="text" placeholder = "i.e (AI2002)" name = "C_ID"></td>
                        <td><input type="text" placeholder="i.e (Artificial Intelligence)" name = "C_Name"></td>
                        <td><input type="number" placeholder="i.e (4)" name = "CR_HOURS"></td>
                    </tr>
                </tbody>
            </table>
		    <input type="submit" class = "btnsubmit" value="Add Course" name="add_course">
        </form>

        <form action="./admin_delcourse.php" method="POST">
            <div class="line"></div>
            <h3>Drop Course</h3>
            <h5>Select Course</h3>
            ...
            <br>
            <br>
            	<input type="submit" class = "GoBackbtn" value="Remove Course" name="add_course">
        </form>
