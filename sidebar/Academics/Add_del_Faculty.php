...
<?php
                ...
                $sql = "SELECT * FROM `TEACHER` ORDER BY USERNAME";
...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>Add/Remove Faculty</h2>
            <br>
            <button class="btnsubmit"><a href="/FLEX/sidebar/Registration/Registration.html">Add Faculty</a></button>
            <h4>Select Faculty ID to delete</h4>
            <form action="Del_Faculty.php" method="POST">
            <select name = "T_ID">
			<?php
		...
		<input type="submit" class = "GoBackbtn" value="Delete" name="showbtn">
        </form>
    </div>
