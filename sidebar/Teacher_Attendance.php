...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="line"></div>
            <br>
            <form action="Teacher_Attendance2.php" method="POST">
            <h5>Select Date</h5>
			...
			<?php
                ...
                if($category["USERNAME"] != $user_name)
                continue;      
			?>
        ...
        <!-- <br> -->
        <input type="submit" class = "AddAttbtn" value="Add" name = "btnsubmit">
        </form>
        <div class="line"></div>
        ...
        <!-- <br> -->
        <input type="submit" class = "DelAttbtn" value = "Delete" name = "btndrop">
        </form>
        </div>
    </div>
