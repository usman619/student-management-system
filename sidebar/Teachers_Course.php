...
<body>
    <?php
                ...
                $sql2 = "SELECT * FROM `TEACHER_COURSE`";
            ...
            // }
                ...
                $query = $conn->prepare("select C_ID from teacher_course;"); 
                $query->execute([]);
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <form action="add_course_teacher.php" method="POST">
        ...
        <form action="del_course_teacher.php" method="POST">
        ...
        <br>
		<input type="submit" class="btndrop" value="Drop" >
        </form>
            <?php
                 if(empty($result))
