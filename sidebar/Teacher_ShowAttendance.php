...
<body>
    ...
    <div class="wrapper">
                ...
                <li>
                 ...
                 <li>
                    ...
                    <ul class="collapse list-unstyled" id="homeSubmenu2">
                        ...
                        <li>
                            <a href="./Teacher_Attendance.php">Show Attendance</a>
                        </li>
                    </ul>
                </li>
        ...
        <div id="content">
            ...
            <!-- Page Content --> 
            <form action="Teacher_ShowAttendance2.php" method="POST">
            <br>
            <h5>Select Course</h3>
		...
		<input type="submit" class = "btnsubmit" value="Show Attendance" name="showbtn">
        </form>
        </div>
    </div>
